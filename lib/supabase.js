...
const PROFILE_COLUMNS = [
  ...
  "tos_accepted_at",
  "tos_version",
  // Collections (migration 057). collection_is_public flips the user's
  // Collection tab from private to publicly rendered on their seller page.
  // collection_about_text is the optional "intro" blurb on that page.
  "collection_is_public",
  "collection_about_text",
].join(", ");
