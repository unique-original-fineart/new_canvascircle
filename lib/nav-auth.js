...
// =============================================================================
// Registers /assets/sw.js on every page that loads nav-auth.js — i.e. every
// page on the site. Without this, the SW file at /assets/sw.js exists but
// the browser never installs it, which means:
