...
if (!document.getElementById("nav-auth-styles")) {
  ...
  style.textContent = `
    ...
    @media (max-width: 640px) {
      ...
      /* No align-self override on the signed-in link — it stretches like
         the other menu items now that it's styled as plain text rather
         than a pill. Stretching is what lets the active-state gradient
         bar at left:0 sit at the menu's left edge instead of overlapping
         the "M" of "My Account". */
