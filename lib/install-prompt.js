...
function ensureModal() {
  ...
  overlay.innerHTML = `
    <div class="cc-install-dialog">
      <h2>Use CanvasCircle as an app</h2>
      <p class="cc-install-lede">Pin CanvasCircle to your home screen and it'll open like a normal app — full screen, no browser bars, faster reloads, and you'll stay signed in.</p>
...
export function mountInstallBanner({ container, copy } = {}) {
  ...
  banner.innerHTML = `
    <div class="cc-install-banner__msg">${copy || `<strong>📱 Use CanvasCircle as an app</strong> — pin it to your home screen for a one-tap, full-screen experience.`}</div>
